...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(_crud) {
        this._crud = _crud;
        this.email = '';
        this.clave = '';
        this.username = '';
    ...
    SignupComponent.prototype.registrar = function () {
        var _this = this;
        this.espiner = true;
        ...
        this._crud.register({ 'email': this.email,
            ...
            'password': this.clave,
            'username': this.nombre }).subscribe(function (data) { _this.espiner = false; }, function (error) {
            _this.espiner = false;
            alert("error");
        });
    };
