...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__Subject__["b"]; });
...
var LoginRoutingModule = /** @class */ (function () {
    ...
    LoginRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__shared_services_crud_service__["a" /* CrudService */]]
        })
    ], LoginRoutingModule);
...
module.exports = "<div class=\"login-page\" [@routerTransition]>\r\n    <div class=\"row justify-content-md-center\">\r\n        <div class=\"col-md-4\">\r\n            <img src=\"assets/images/logo.png\" width=\"150px\" class=\"user-avatar\" />\r\n            <h1>Iniciar Sesión</h1>\r\n            <form role=\"form\">\r\n                <div class=\"form-content\">\r\n                    <div class=\"form-group\">\r\n                        <input type=\"text\"   [(ngModel)]=\"email\" name=\"email\"\r\n                            class=\"form-control input-underline input-lg\" placeholder=\"Email\">\r\n                    </div>\r\n\r\n                    <div class=\"form-group\">\r\n                        <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" placeholder=\"Contraseña\"\r\n                        class=\"form-control input-underline input-lg\">\r\n                    </div>\r\n                </div>\r\n                <!-- <a class=\"btn rounded-btn\"  (click)=\"onLoggedin()\" *ngIf=\"!espiner\"> Ingresar </a> -->\r\n                <a class=\"btn rounded-btn\" *ngIf=\"!espiner\" (click)=\"onLoggedin()\">Ingresar</a>\r\n\r\n\r\n                <a class=\"btn rounded-btn\" *ngIf=\"espiner\">Espere por favor <i class=\"fa fa-spinner fa-spin\"></i> </a>\r\n                &nbsp;\r\n                <a class=\"btn rounded-btn\" *ngIf=\"!espiner\" [routerLink]=\"['/signup']\">Registrar</a>\r\n                                \r\n                &nbsp;\r\n            </form>\r\n            \r\n<button (click)=\"prender()\">Prender Foco</button>\r\n<button (click)=\"apagar()\"> Apagar Foco</button>\r\n        </div>\r\n    </div>\r\n</div>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_services_dispositivo_service__ = __webpack_require__("./src/app/shared/services/dispositivo.service.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, _crudService, soIO) {
        this.router = router;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        this.soIO.messages.subscribe(function (msg) {
            console.log(msg);
        });
    };
    LoginComponent.prototype.onLoggedin = function () {
        ...
        this._crudService.login({ 'email': this.email, 'password': this.password })
            ...
            if (data) {
                ...
                localStorage.setItem('user', JSON.stringify(_this.email));
    ...
    LoginComponent.prototype.prender = function () {
        this.soIO.sendMsg("prenderFoco");
    };
    LoginComponent.prototype.apagar = function () {
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_4__shared_services_crud_service__["a" /* CrudService */], __WEBPACK_IMPORTED_MODULE_0__shared_services_dispositivo_service__["a" /* dispositivo */]])
    ], LoginComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_services_websocket_service__ = __webpack_require__("./src/app/shared/services/websocket.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginModule = /** @class */ (function () {
    ...
    LoginModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_8__login_component__["a" /* LoginComponent */]],
            providers: [__WEBPACK_IMPORTED_MODULE_6__shared_services_crud_service__["a" /* CrudService */], __WEBPACK_IMPORTED_MODULE_0__shared_services_dispositivo_service__["a" /* dispositivo */], __WEBPACK_IMPORTED_MODULE_9__shared_services_websocket_service__["a" /* WebsocketService */]]
        })
    ], LoginModule);
    return LoginModule;
}());
...
/***/ "./src/app/shared/services/dispositivo.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var dispositivo = /** @class */ (function () {
    function dispositivo(wsService) {
    ...
    dispositivo.prototype.sendMsg = function (msg) {
...
var WebsocketService = /** @class */ (function () {
    ...
    WebsocketService.prototype.connect = function () {
        ...
        var observable = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["a" /* Observable */](function (observer) {
        ...
        return __WEBPACK_IMPORTED_MODULE_4_rxjs_Rx__["a" /* Subject */].create(observer, observable);
    };
