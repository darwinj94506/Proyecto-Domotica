...
module.exports = "<div [@routerTransition]>\r\n    <!-- <app-page-header [heading]=\"'Aprobadas'\" [icon]=\"'fa-edit'\"></app-page-header> -->\r\n    <div class=\"row\">\r\n        <div class=\"col col-xl-12 col-lg-12\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                    <div class=\"btn btn-light disabled\" style=\"opacity: 1;\">Solicitudes</div>\r\n                    <div class=\"float-right\">\r\n                            <!-- <button type=\"button\" [routerLink]=\"['categoria',nueva,'Nueva']\"\r\n                                 class=\"btn btn-success\">\r\n                                <i class=\"fa fa-plus\"></i>Nueva\r\n                            </button> -->\r\n                    </div>\r\n                </div>\r\n                <div class=\"card-body table-responsive\">\r\n                    <table class=\"table\">\r\n                        <thead>\r\n                        <tr>\r\n                            <th>#</th>\r\n                            <th>Participante</th>\r\n                            <th>Grupo</th>\r\n                            <th>Categoria</th>\r\n                            <th>Estado</th>\r\n                            <th></th>\r\n                        </tr>\r\n                        </thead>\r\n                        <tbody>\r\n                            <tr *ngFor=\"let sol of solicitudes; let i=index\">\r\n                                <td>{{i+1}}</td>\r\n                                <td>{{sol.usuario.username}}</td>\r\n                                <td>{{sol.grupo.nombre}}</td>\r\n                                <td>{{sol.categoria.nombre}}</td>\r\n                                <td>{{sol.estado}}</td>\r\n                                <td>  \r\n                                    <div class=\"btn-group btn-group-sm  mr-2\" role=\"group\" aria-label=\"Basic example\">\r\n                                        <button type=\"button\" [routerLink]=\"['solicitud',sol.id,'Solicitud']\"\r\n                                             [routerLinkActive]=\"['router-link-active']\"\r\n                                             class=\"btn btn-primary\">\r\n                                                <i class=\"fa fa-eye\" aria-hidden=\"true\"></i>\r\n                                            </button>\r\n                                        <!-- <button type=\"button\" [routerLink]=\"['categoria',sol.id,'Editar']\" \r\n                                                class=\"btn btn-success\">\r\n                                                <i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>\r\n                                            </button> -->\r\n                                        <!-- <button type=\"button\" [routerLink]=\"['categoria',sol.id]\"\r\n                                                 class=\"btn btn-danger\">\r\n                                                <i class=\"fa fa-trash-o\" aria-hidden=\"true\"></i>\r\n                                        </button> -->\r\n                                      </div>\r\n                                </td>\r\n                              \r\n                                \r\n                            </tr>\r\n                        </tbody>\r\n                    </table>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>"
...
var BsComponentComponent = /** @class */ (function () {
    function BsComponentComponent(_crudService) {
        this._crudService = _crudService;
    }
    BsComponentComponent.prototype.ngOnInit = function () {
        this.getSolicitudes();
    };
    BsComponentComponent.prototype.getSolicitudes = function () {
        var _this = this;
        this._crudService.getSolicitudesAceptadas().subscribe(function (response) {
            console.log(response);
            if (!response) {
                console.log('solicitudes');
            }
            else {
                _this.solicitudes = response;
    ...
    BsComponentComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__shared_services_crud_service__["a" /* CrudService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bs_component_routing_module__ = __webpack_require__("./src/app/layout/bs-component/bs-component-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__bs_component_component__ = __webpack_require__("./src/app/layout/bs-component/bs-component.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components__ = __webpack_require__("./src/app/layout/bs-component/components/index.ts");
    ...
    BsComponentModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__bs_component_routing_module__["a" /* BsComponentRoutingModule */],
                __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* ReactiveFormsModule */],
                __WEBPACK_IMPORTED_MODULE_2__ng_bootstrap_ng_bootstrap__["f" /* NgbModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_9__shared__["d" /* PageHeaderModule */], __WEBPACK_IMPORTED_MODULE_5__angular_http__["c" /* HttpModule */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_7__bs_component_component__["a" /* BsComponentComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["b" /* ButtonsComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["a" /* AlertComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["f" /* ModalComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["c" /* CollapseComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["d" /* DatePickerComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["e" /* DropdownComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["g" /* PaginationComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["h" /* PopOverComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["i" /* ProgressbarComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["k" /* TabsComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["j" /* RatingComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["m" /* TooltipComponent */],
                __WEBPACK_IMPORTED_MODULE_8__components__["l" /* TimepickerComponent */]
            ], providers: [__WEBPACK_IMPORTED_MODULE_4__shared_services_crud_service__["a" /* CrudService */]]
        })
    ], BsComponentModule);
...
module.exports = "\r\n<div [@routerTransition]>\r\n    <app-page-header [heading]=\"'Agregar'\" [icon]=\"'fa-plus'\"></app-page-header>\r\n    <div class=\"row\">\r\n        <div class=\"col col-xl-12 col-lg-12\">\r\n            <form role=\"form\">\r\n                <div class=\"form-content\">\r\n                    <div class=\"row justify-content-around\">\r\n                        <div class=\"col-sm-5\">\r\n                            <div class=\"form-group text-center\">\r\n                                <img class=\"img-rounded img-thumbnail\" src=\"assets/images/bill.png\" width=\"70%\">\r\n                            </div>\r\n                        </div>\r\n                        <div class=\"col-sm-7\">\r\n                            <div class=\"form-group row\">\r\n                                <label for=\"Id\" class=\"col-5 col-lg-4 col-form-label\">ID: </label>\r\n                                <div class=\"col-7\">\r\n                                    <input type=\"text\" readonly class=\"form-control-plaintext input-underline input-lg\" id=\"Id\" placeholder=\"ID\">\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"form-group row\">\r\n                                <label for=\"Usuario\" class=\"col-5 col-lg-4 col-form-label\">Usuario: </label>\r\n                                <div class=\"col-7\">\r\n                                    <input type=\"text\" readonly class=\"form-control-plaintext input-underline input-lg\" id=\"Usuario\" placeholder=\"Usuario\">\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"form-group row\">\r\n                                <label for=\"Grupo\" class=\"col-5 col-lg-4 col-form-label\">Grupo: </label>\r\n                                <div class=\"col-7\">\r\n                                    <input type=\"text\" readonly class=\"form-control-plaintext input-underline input-lg\" id=\"Grupo\" placeholder=\"Grupo\">\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"form-group row\">\r\n                                <label for=\"FechaCreacion\" class=\"col-5 col-lg-4 col-form-label\">Fecha de Creación: </label>\r\n                                <div class=\"col-7\">\r\n                                    <input type=\"date\" readonly class=\"form-control-plaintext input-underline input-lg\" id=\"FechaCreacion\" placeholder=\"Fecha de Creación\"\r\n                                        value=\"2018-12-15\">\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"form-group row\">\r\n                                <label for=\"Descripcion\" class=\"col-5 col-lg-4 col-form-label\">Descripción: </label>\r\n                                <div class=\"col-7\">\r\n                                    <textarea readonly class=\"form-control-plaintext input-underline input-lg\" id=\"Descripcion\" aria-label=\"With textarea\" placeholder=\"Descripción\"></textarea>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <div class=\"row justify-content-center\">\r\n                    <div class=\"col-7 row justify-content-around\">\r\n                        <a class=\" col-sm-3 btn btn-dark rounded-btn\" [routerLink]=\"['/tables']\"> Atrás </a>\r\n                        <a class=\" col-sm-3 btn btn-danger rounded-btn\" [routerLink]=\"['/tables']\"> Eliminar </a>\r\n                        <a class=\" col-sm-3 btn btn-success rounded-btn\" [routerLink]=\"['/tables']\"> Verificar </a>\r\n                    </div>\r\n                </div>\r\n            </form>\r\n        </div>\r\n    </div>\r\n</div>"
